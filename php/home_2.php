	...
	<div class="revolution-slider" data-version="5.4.5" style="display: none;">
		<ul>
			...
			<li data-transition="fade" data-masterspeed="500" data-slotamount="1" data-delay="6000">
				<!-- MAIN IMAGE -->
				<img src="images/slider/placeholder.jpg" alt="slidebg1" data-bgfit="cover">
				<!-- LAYERS -->
				<!-- LAYER 01 -->
				...
				<div class="tp-caption"
					...
					>
					<h2><a href="?page=service_calculator" title="Estimate Total Costs">ESTIMATE TOTAL COSTS</a></h2>
				</div>
				<!-- LAYER 03 -->
				<div class="tp-caption"
			...
			<li data-transition="fade" data-masterspeed="500" data-slotamount="1" data-delay="6000">
				<!-- MAIN IMAGE -->
				<img src="images/slider/placeholder.jpg" alt="slidebg2" data-bgfit="cover">
				<!-- LAYERS -->
				<!-- LAYER 01 -->
			...
			<li data-transition="fade" data-masterspeed="500" data-slotamount="1" data-delay="6000">
				<!-- MAIN IMAGE -->
				<img src="images/slider/placeholder.jpg" alt="slidebg3" data-bgfit="cover">
				<!-- LAYERS -->
				<!-- LAYER 01 -->
				<div class="tp-caption customin customout"
					data-frames='[{"delay":500,"speed":1500,"from":"y:-40;o:0;","ease":"easeInOutExpo"},{"delay":"wait","speed":500,"to":"o:0;","ease":"easeInOutExpo"}]'
...
<div class="theme-page">
	<div class="clearfix">
		<div class="row margin-top-89">
			<div class="row">
				<h2 class="box-header">CLEANING SERVICES</h2>
				<p class="description align-center">We are local home cleaning services proffesionals and pledge to clean thoroughly,<br>completely and reliably. Below are our most common cleaning areas.</p>
				<div class="carousel-container margin-top-65 clearfix">
					<ul class="services-list services-icons horizontal-carousel gray clearfix">
						<li class="column column-1-3">
							...
							<h4><a href="?page=service_house_cleaning" title="House Cleaning">HOUSE CLEANING</a></h4>
							...
							<div class="align-center margin-top-42 padding-bottom-16">
								<a class="more" href="?page=service_house_cleaning" title="Learn more">Learn more</a>
							</div>
						</li>
						<li class="column column-1-3">
							...
							<h4><a href="?page=service_post_renovation" title="Post Renovation">POST RENOVATION</a></h4>
							<p>Get rid of the dust left behind after construction and renovation.</p>
							<div class="align-center margin-top-42 padding-bottom-16">
								<a class="more" href="?page=service_post_renovation" title="Learn more">Learn more</a>
							</div>
						</li>
						<li class="column column-1-3">
							...
							<div class="align-center margin-top-42 padding-bottom-16">
								<a class="more" href="?page=service_green_spaces_maintenance" title="Learn more">Learn more</a>
							</div>
						</li>
						<li class="column column-1-3">
							...
							<h4><a href="?page=service_move_in_out" title="Move In Out Service">MOVE IN OUT SERVICE</a></h4>
							<p>We'll leave the place you're leaving look even better than it did when you moved in.</p>
							<div class="align-center margin-top-42 padding-bottom-16">
								<a class="more" href="?page=service_move_in_out" title="Learn more">Learn more</a>
							</div>
						</li>
						<li class="column column-1-3">
							...
							<h4><a href="?page=service_commercial_cleaning" title="Commercial Cleaning">COMMERCIAL CLEANING</a></h4>
							<p>Only the most skilled professionals for commercial office cleaning.</p>
							<div class="align-center margin-top-42 padding-bottom-16">
								<a class="more" href="?page=service_commercial_cleaning" title="Learn more">Learn more</a>
							</div>
						</li>
						<li class="column column-1-3">
							...
							<h4><a href="?page=service_window_cleaning" title="Window Cleaning">WINDOW CLEANING</a></h4>
							<p>The highest quality window cleaning service at a competitive price.</p>
							<div class="align-center margin-top-42 padding-bottom-16">
								<a class="more" href="?page=service_window_cleaning" title="Learn more">Learn more</a>
							</div>
						</li>
						<li class="column column-1-3">
							<a href="?page=service_house_cleaning" title="House Cleaning">
		...
		<div class="row full-width gray flex-box page-margin-top-section">
			<div class="column column-1-2 background-1">
				<a class="flex-hide" href="?page=project_garden_maintenance" title="Garden Maintenance">
					<img src="images/samples/960x750/placeholder.jpg" alt="">
				</a>
			</div>
		...
		<div class="row page-margin-top-section padding-bottom-100">
			...
			<div class="column column-1-4">
				<a href="images/samples/480x693/placeholder.jpg" class="prettyPhoto cm-preload" title="Gutter Cleaning">
					<img src='images/samples/480x693/placeholder.jpg' alt='img'>
				</a>
			</div>
			<div class="column column-1-4">
				<div class="row">
				...
				<div class="row margin-top-30">
					<a href="images/samples/480x320/placeholder.jpg" class="prettyPhoto cm-preload" title="After Renovation Cleaning">
						<img src='images/samples/480x320/placeholder.jpg' alt='img'>
					</a>
				</div>
			</div>
		...
		<div class="row full-width padding-top-59 padding-bottom-60 align-center">
			<h3><span class="button-label">DO YOU LIKE WHAT YOU SEE?</span> <a class="more" target="_blank" href="https://1.envato.market/c/296919/275988/4415?u=https://themeforest.net/cart/add_items?item_ids=20493947&ref=QuanticaLabs" title="Purchase now">Purchase now</a></h3>
		</div>
		<div class="row full-width gray flex-box">
			<div class="column column-1-3 padding-bottom-96">
				<div class="row padding-left-right-70 margin-top-89">
					...
					<ul class="list margin-top-20">
						<li class="template-tick-1">Offer a different kind of services to families and professionals</li>
			...
			<div class="column column-1-3 padding-bottom-100 green">
				<div class="row padding-left-right-70 margin-top-89">
					...
					<h2>Please call now: <a href="tel:2507257052">250 725 7052</a></h2>
		...
		<div class="row full-width padding-top-89 padding-bottom-100">
			<div class="row">
				...
				<ul class="team-list gray margin-top-65 clearfix">

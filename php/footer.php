			...
			<div class="row dark-gray footer-row full-width padding-top-61 padding-bottom-36">
				...
				<div class="row align-center padding-top-30">
					<span class="copyright">© Copyright 2023 <a href="https://1.envato.market/cleanmate-cleaning-company-maid-gardening-template" title="Cleanmate Template" target="_blank">Cleanmate Template</a> by <a href="https://quanticalabs.com" title="QuanticaLabs" target="_blank">QuanticaLabs</a></span>
				</div>
			</div>
		</div>
		...
		<?php if(isset($_GET["page"]) && ($_GET["page"]=="contact" || $_GET["page"]=="contact_2" || $_GET["page"]=="contact_3")):?>
		<script type="text/javascript" src="//maps.google.com/maps/api/js?key=YOUR_API_KEY&amp;callback=cleanmateInitMap"></script>
		<?php endif; ?>

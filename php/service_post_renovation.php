			...
			<div class="column column-3-4">
				<div class="row">
					<div class="column column-1-2">
						<a href="images/samples/480x320/placeholder.jpg" class="prettyPhoto cm-preload" title="Post Renovation">
							<img src='images/samples/480x320/placeholder.jpg' alt='img'>
						</a>
					</div>
					<div class="column column-1-2">
						<a href="images/samples/870x580/placeholder.jpg" class="prettyPhoto cm-preload" title="Post Renovation">
							<img src='images/samples/480x320/placeholder.jpg' alt='img'>
						</a>
					</div>
				</div>
				<div class="row page-margin-top">
					<div class="column-1-1">
						...
						<p class="description">Cleanmate opperates in Ottawa and provides a variety of cleaning services. Choose us because of our reputation for excellence. We provide proffesional cleaning services designed to keep your home sparkling and beautiful so that you can focus on things that matter more to you.</p>
					</div>
				</div>
				<div class="row page-margin-top">
					<div class="column column-1-2">
						<h4>WE GUARANTEE</h4>
						<p class="margin-top-14">Our continuous pursuit for perfection has resulted in consistent growth each year. Our focus is to listen to our clients, understand their needs and provide the exceptional level of residential and commercial cleaning services.</p>
